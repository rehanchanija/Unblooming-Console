  ...
  if (!product) {
    return (
      <div className="min-h-screen pt-32 text-center">
        ...
        <Link href="/#products" className="text-orange-500 mt-4 inline-block">Return to Store</Link>
      </div>
    );
  }
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-4">
            <div className="relative aspect-square bg-[#0a0a0a] rounded-3xl overflow-hidden border border-gray-200 shadow-xl">
              <Image 
              ...
              <div className="flex space-x-4 overflow-x-auto hide-scrollbar py-2">
                {product.gallery.map((img, idx) => (
                  <button 
                    ...
                    className={`relative w-24 h-24 flex-shrink-0 bg-[#0a0a0a] rounded-xl overflow-hidden border-2 transition-colors ${activeImage === idx ? 'border-orange-500' : 'border-transparent opacity-70 hover:opacity-100'}`}
                  >
          ...
          <div className="flex flex-col space-y-8">
            <div>
              <div className="flex items-center space-x-2 mb-3">
                ...
                <span className="text-sm font-bold text-gray-500">{product.rating} / 5</span>
            ...
            <div className="pt-6 border-t border-gray-200">
              ...
              <div className="mt-4 flex justify-center space-x-6 text-sm font-bold text-gray-500">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-20">
          ...
          <div className="bg-white rounded-3xl p-8 md:p-10 border border-gray-200 shadow-sm">
            ...
            <ul className="space-y-4">
              {Object.entries(product.specs).map(([key, value]) => (
                <li key={key} className="flex flex-col sm:flex-row sm:justify-between py-3 border-b border-gray-100 last:border-0">
                  <span className="text-gray-500 font-medium mb-1 sm:mb-0">{key}</span>
          ...
          {/* Reviews */}
          <div className="bg-white rounded-3xl p-8 md:p-10 border border-gray-200 shadow-sm" id="reviews">
              ...
              {product.reviews.map((review, idx) => (
                <div key={idx} className="pb-6 border-b border-gray-100 last:border-0 last:pb-0">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <span className="text-xs text-green-600 font-bold bg-green-100 px-2 py-0.5 rounded">Verified</span>
                  </div>
